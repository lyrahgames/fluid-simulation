...
struct qt_meta_stringdata_RenderW_t {
    QByteArrayData data[3];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RenderW_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RenderW_t qt_meta_stringdata_RenderW = {
    {
QT_MOC_LITERAL(0, 0, 7), // "RenderW"
...
const QMetaObject RenderW::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RenderW.data,
      qt_meta_data_RenderW,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RenderW::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RenderW.stringdata0))
